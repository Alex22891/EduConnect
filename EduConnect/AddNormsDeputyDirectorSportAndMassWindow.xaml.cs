...
{
    /// <summary>
    /// Логика взаимодействия для AddNormsDeputyDirectorSportAndMassWindow.xaml
    /// </summary>
    public partial class AddNormsDeputyDirectorSportAndMassWindow : MetroWindow
    {
        ...
        public AddNormsDeputyDirectorSportAndMassWindow(Normative EditedNorms, DeputyDirectorForSportsAndMassSportsWorkWindow deputyDirectorForSports)
        {
            InitializeComponent();
        ...
        private void AddButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                deputyDirectorForSports.LoadNormsData();
